...
| M3 | Contagem espectral N(E) = θ(E)/π + 1 + S(E) (Berry–Keating 1999, SIAM p. 239, eqs. 2.1–2.4, secundária, escrita "for the t_n (assumed real)"; versão incondicional clássica em Titchmarsh cap. 9, não conferida; a citação anterior "DLMF §25.10" foi corrigida em 11.3b: a página define Z e ϑ, mas não traz a fórmula), o que inclui a média de Riemann–von Mangoldt N̄(E) = (E/2π)log(E/2π) − E/2π + 7/8 + O(1/E). |
...
| 11.6 | Controles dinâmico, aritmético e de ajuste: especificação e fontes | idem | pendente |
