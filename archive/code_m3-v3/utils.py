...
class ExecutionTimer:
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        try:
            ...
            # RUSAGE_CHILDREN: maior RSS entre os filhos já encerrados (não é soma dos simultâneos)
            self.peak_children_bytes = resource.getrusage(resource.RUSAGE_CHILDREN).ru_maxrss * 1024
        except Exception:
            self.peak_memory_bytes = 0
