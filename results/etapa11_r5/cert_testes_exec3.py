"""Testes obrigatórios T1–T6 (adendo 1) e T7–T8 (adendo 2); devem passar antes da reexecução."""
...
ok = (res["T7"]["n_falhas"] == 0 and res["T8"]["n_falhas"] == 0 and res["T1"]["n_falhas"] == 0 and not res["T2"]["falhas"] and res["T3"]["n_falhas"] == 0 and not res["T4"]["falhas"]
