...
(hashes verificados). Execução 3: extremos exatos (Fraction); só +, −, ×, ÷ em binary64 com nextafter; finitude verificada;
...
if __name__ == "__main__":
    ...
    summ = {"declaracao_sha256": open("results/etapa11_r5/DECLARACAO_CERT.sha256").read().split()[0],
            ...
            "adendo2_sha256": open("results/etapa11_r5/DECLARACAO_CERT_CORRECAO2.sha256").read().split()[0], "execucao": 3,
