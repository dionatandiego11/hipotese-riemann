...
conforme results/etapa11_r5/DECLARACAO_CERT.md e o adendo DECLARACAO_CERT_CORRECAO1.md (hashes verificados).
Execução 2: extremos intervalares lidos exatamente (Fraction), sem conversão por mpf(…).
...
if __name__ == "__main__":
    ...
    for b in sorted(res, key=lambda r: (r["versao"], r["bloco"])):
        ...
        for k, c in enumerate(catalog):
            ...
            rows.append({"versao": b["versao"], "bloco": b["bloco"], "p": c["prime"], "r": c["repetition"], "eligible": elig[kk],
                         ...
                         "certificado": hi_q(tot) <= Fraction(1, 10**6) and b["rho"] < 1 and b["vmin"] >= math.sqrt(2) and sinfo["crivo_conferido"]})
    ...
    summ = {"declaracao_sha256": open("results/etapa11_r5/DECLARACAO_CERT.sha256").read().split()[0],
            "adendo1_sha256": open("results/etapa11_r5/DECLARACAO_CERT_CORRECAO1.sha256").read().split()[0], "execucao": 2,
